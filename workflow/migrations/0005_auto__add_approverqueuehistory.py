...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApproverQueueHistory'
        db.create_table('workflow_approverqueuehistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('approver_queue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.ApproverQueue'])),
            ('prev_sequence', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('prev_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DropdownValue'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('workflow', ['ApproverQueueHistory'])


    def backwards(self, orm):
        # Deleting model 'ApproverQueueHistory'
        db.delete_table('workflow_approverqueuehistory')
    ...
    models = {
        ...
        'workflow.approverqueue': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.DropdownValue']"})
        },
        'workflow.approverqueuehistory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prev_sequence': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'prev_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.DropdownValue']"})
        },
        'workflow.queue': {
