...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.name'
        db.add_column('workflow_queue', 'name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Adding field 'Queue.description'
        db.add_column('workflow_queue', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.name'
        db.delete_column('workflow_queue', 'name')

        # Deleting field 'Queue.description'
        db.delete_column('workflow_queue', 'description')
