...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApproverQueue.last_updated'
        db.alter_column('workflow_approverqueue', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ApproverQueue.last_updated'
        db.alter_column('workflow_approverqueue', 'last_updated', self.gf('django.db.models.fields.DateTimeField')())
