...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Approver.user'
        db.add_column('workflow_approver', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Approver.role'
        db.alter_column('workflow_approver', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Role'], null=True))

    def backwards(self, orm):
        # Deleting field 'Approver.user'
        db.delete_column('workflow_approver', 'user_id')


        # Changing field 'Approver.role'
        db.alter_column('workflow_approver', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Role']))
    ...
    models = {
        ...
        'workflow.approver': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Role']", 'null': 'True', 'blank': 'True'}),
