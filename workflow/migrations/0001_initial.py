...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Approver'
        db.create_table('workflow_approver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('queue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.Queue'])),
        ))
        db.send_create_signal('workflow', ['Approver'])

        # Adding model 'ApproverQueue'
        db.create_table('workflow_approverqueue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('current_sequence', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('current_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal('workflow', ['ApproverQueue'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Approver'
        db.delete_table('workflow_approver')

        # Deleting model 'ApproverQueue'
        db.delete_table('workflow_approverqueue')
