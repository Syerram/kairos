...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimeOffPolicy.tracked'
        db.add_column('timeoff_timeoffpolicy', 'tracked',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TimeOffPolicy.tracked'
        db.delete_column('timeoff_timeoffpolicy', 'tracked')
    ...
    models = {
        ...
        'timeoff.usertimeoff': {
            'Meta': {'object_name': 'UserTimeOff'},
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
            'timeoff_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_timeoff_type'", 'to': "orm['timeoff.TimeOffType']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'timeoff.usertimeoffhistory': {
            'Meta': {'object_name': 'UserTimeOffHistory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user_timeoff': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_timeoff'", 'to': "orm['timeoff.UserTimeOff']"}),
