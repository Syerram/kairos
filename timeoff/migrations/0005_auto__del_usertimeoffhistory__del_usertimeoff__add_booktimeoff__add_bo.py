...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UserTimeOffHistory'
        db.delete_table('timeoff_usertimeoffhistory')

        # Deleting model 'UserTimeOff'
        db.delete_table('timeoff_usertimeoff')

        # Adding model 'BookTimeOff'
        db.create_table('timeoff_booktimeoff', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timeoff_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='book_timeoff_type', to=orm['timeoff.TimeOffType'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('timeoff', ['BookTimeOff'])

        # Adding model 'BookTimeOfffHistory'
        db.create_table('timeoff_booktimeofffhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('book_timeoff', self.gf('django.db.models.fields.related.ForeignKey')(related_name='book_timeoff', to=orm['timeoff.BookTimeOff'])),
            ('book_timeoff_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DropdownValue'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('timeoff', ['BookTimeOfffHistory'])


    def backwards(self, orm):
        # Adding model 'UserTimeOffHistory'
        db.create_table('timeoff_usertimeoffhistory', (
            ('user_timeoff_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DropdownValue'])),
            ('user_timeoff', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_timeoff', to=orm['timeoff.UserTimeOff'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('timeoff', ['UserTimeOffHistory'])

        # Adding model 'UserTimeOff'
        db.create_table('timeoff_usertimeoff', (
            ('timeoff_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_timeoff_type', to=orm['timeoff.TimeOffType'])),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('timeoff', ['UserTimeOff'])

        # Deleting model 'BookTimeOff'
        db.delete_table('timeoff_booktimeoff')

        # Deleting model 'BookTimeOfffHistory'
        db.delete_table('timeoff_booktimeofffhistory')
    ...
    models = {
        ...
        'timeoff.booktimeoff': {
            'Meta': {'object_name': 'BookTimeOff'},
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
            'timeoff_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_timeoff_type'", 'to': "orm['timeoff.TimeOffType']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'timeoff.booktimeofffhistory': {
            'Meta': {'object_name': 'BookTimeOfffHistory'},
            'book_timeoff': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_timeoff'", 'to': "orm['timeoff.BookTimeOff']"}),
            'book_timeoff_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.DropdownValue']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
