...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeOffPolicy.max_overdraw_limit'
        db.alter_column('timeoff_timeoffpolicy', 'max_overdraw_limit', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'TimeOffPolicy.max_overdraw_limit'
        db.alter_column('timeoff_timeoffpolicy', 'max_overdraw_limit', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
