...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookTimeOff.timeoff_type'
        db.alter_column('timeoff_booktimeoff', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.TimeOffType']))

        # Changing field 'TimeOffPolicy.timeoff_type'
        db.alter_column('timeoff_timeoffpolicy', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.TimeOffType']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BookTimeOff.timeoff_type'
        db.alter_column('timeoff_booktimeoff', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeoff.TimeOffType']))

        # Changing field 'TimeOffPolicy.timeoff_type'
        db.alter_column('timeoff_timeoffpolicy', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeoff.TimeOffType']))
