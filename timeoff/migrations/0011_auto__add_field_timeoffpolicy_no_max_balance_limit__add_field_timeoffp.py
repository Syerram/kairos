...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeOffPolicy.no_max_balance_limit'
        db.add_column('timeoff_timeoffpolicy', 'no_max_balance_limit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TimeOffPolicy.no_max_overdraw_limit'
        db.add_column('timeoff_timeoffpolicy', 'no_max_overdraw_limit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeOffPolicy.no_max_balance_limit'
        db.delete_column('timeoff_timeoffpolicy', 'no_max_balance_limit')

        # Deleting field 'TimeOffPolicy.no_max_overdraw_limit'
        db.delete_column('timeoff_timeoffpolicy', 'no_max_overdraw_limit')
    ...
    models = {
        ...
        'timeoff.booktimeoff': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_of_days': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
            'timeoff_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_timeoff_type'", 'to': "orm['categories.TimeOffType']"}),
        ...
        'timeoff.timeoffpolicy': {
            ...
            'max_overdraw_limit': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
            'no_max_balance_limit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'no_max_overdraw_limit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'timeoff_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timeoff_type'", 'to': "orm['categories.TimeOffType']"}),
