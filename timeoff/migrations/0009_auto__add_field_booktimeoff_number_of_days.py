...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookTimeOff.number_of_days'
        db.add_column('timeoff_booktimeoff', 'number_of_days',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookTimeOff.number_of_days'
        db.delete_column('timeoff_booktimeoff', 'number_of_days')
