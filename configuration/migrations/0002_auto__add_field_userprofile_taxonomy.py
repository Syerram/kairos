...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.taxonomy'
        db.add_column('configuration_userprofile', 'taxonomy',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categories.Taxonomy'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.taxonomy'
        db.delete_column('configuration_userprofile', 'taxonomy_id')
    ...
    models = {
        ...
        'configuration.userprofile': {
            ...
            'taxonomy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Taxonomy']", 'unique': 'True'}),
