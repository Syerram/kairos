...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserTimeOffPolicy.timeoff_type'
        db.alter_column('configuration_usertimeoffpolicy', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.TimeOffType']))

    def backwards(self, orm):

        # Changing field 'UserTimeOffPolicy.timeoff_type'
        db.alter_column('configuration_usertimeoffpolicy', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeoff.TimeOffType']))
