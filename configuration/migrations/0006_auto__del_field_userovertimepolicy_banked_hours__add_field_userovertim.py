...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserOverTimePolicy.banked_hours'
        db.delete_column('configuration_userovertimepolicy', 'banked_hours')

        # Adding field 'UserOverTimePolicy.bank_user_timeoff_policy'
        db.add_column('configuration_userovertimepolicy', 'bank_user_timeoff_policy',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='bank_to_user_timeoff', to=orm['configuration.UserTimeOffPolicy']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserOverTimePolicy.banked_hours'
        db.add_column('configuration_userovertimepolicy', 'banked_hours',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Deleting field 'UserOverTimePolicy.bank_user_timeoff_policy'
        db.delete_column('configuration_userovertimepolicy', 'bank_user_timeoff_policy_id')
    ...
    models = {
        ...
        'configuration.userovertimepolicy': {
            ...
            'bank_user_timeoff_policy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bank_to_user_timeoff'", 'to': "orm['configuration.UserTimeOffPolicy']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
