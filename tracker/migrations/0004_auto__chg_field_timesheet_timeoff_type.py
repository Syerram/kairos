...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timesheet.timeoff_type'
        db.alter_column('tracker_timesheet', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['categories.TimeOffType']))

    def backwards(self, orm):

        # Changing field 'Timesheet.timeoff_type'
        db.alter_column('tracker_timesheet', 'timeoff_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['timeoff.TimeOffType']))
