...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WeekSnapshotHistory'
        db.create_table('tracker_weeksnapshothistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('weeksnapshot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.WeekSnapshot'])),
            ('weeksnapshot_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DropdownModel'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('tracker', ['WeekSnapshotHistory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'WeekSnapshotHistory'
        db.delete_table('tracker_weeksnapshothistory')
    ...
    models = {
        ...
        'tracker.weeksnapshothistory': {
            ...
            'weeksnapshot_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.DropdownModel']"})
        }
    }
