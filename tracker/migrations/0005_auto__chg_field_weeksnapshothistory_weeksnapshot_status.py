...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeekSnapshotHistory.weeksnapshot_status'
        db.alter_column('tracker_weeksnapshothistory', 'weeksnapshot_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DropdownValues']))

    def backwards(self, orm):

        # Changing field 'WeekSnapshotHistory.weeksnapshot_status'
        db.alter_column('tracker_weeksnapshothistory', 'weeksnapshot_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DropdownModel']))
    ...
    models = {
        ...
        'tracker.weeksnapshothistory': {
            ...
            'weeksnapshot_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.DropdownValues']"})
        }
    }
