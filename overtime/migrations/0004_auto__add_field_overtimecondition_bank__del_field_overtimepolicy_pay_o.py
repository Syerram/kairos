...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OvertimeCondition.bank'
        db.add_column('overtime_overtimecondition', 'bank',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'OvertimePolicy.pay_or_bank'
        db.delete_column('overtime_overtimepolicy', 'pay_or_bank')


    def backwards(self, orm):
        # Deleting field 'OvertimeCondition.bank'
        db.delete_column('overtime_overtimecondition', 'bank')

        # Adding field 'OvertimePolicy.pay_or_bank'
        db.add_column('overtime_overtimepolicy', 'pay_or_bank',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
