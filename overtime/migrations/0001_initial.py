...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OvertimePolicy'
        db.create_table('overtime_overtimepolicy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=125)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('pay_or_bank', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('overtime', ['OvertimePolicy'])

        # Adding model 'OvertimeCondition'
        db.create_table('overtime_overtimecondition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('overtime_policy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='overtime_policy', to=orm['overtime.OvertimePolicy'])),
            ('ruleset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='overtime_ruleset', to=orm['rules.RuleSet'])),
        ))
        db.send_create_signal('overtime', ['OvertimeCondition'])


    def backwards(self, orm):
        # Deleting model 'OvertimePolicy'
        db.delete_table('overtime_overtimepolicy')

        # Deleting model 'OvertimeCondition'
        db.delete_table('overtime_overtimecondition')
