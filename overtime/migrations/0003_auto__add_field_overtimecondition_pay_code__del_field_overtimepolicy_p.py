...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OvertimeCondition.pay_code'
        db.add_column('overtime_overtimecondition', 'pay_code',
    ...
    def backwards(self, orm):
        # Deleting field 'OvertimeCondition.pay_code'
        db.delete_column('overtime_overtimecondition', 'pay_code_id')
