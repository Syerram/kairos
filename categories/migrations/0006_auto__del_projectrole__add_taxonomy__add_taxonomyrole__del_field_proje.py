...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('categories_projectrole')

        # Adding model 'Taxonomy'
        db.create_table('categories_taxonomy', (
        ...
        db.send_create_signal('categories', ['Taxonomy'])

        # Adding model 'TaxonomyRole'
        db.create_table('categories_taxonomyrole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('categories', ['TaxonomyRole'])

        # Deleting field 'Project.client'
        db.delete_column('categories_project', 'client_id')

        # Adding field 'Project.taxonomy'
        db.add_column('categories_project', 'taxonomy',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categories.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'ProjectRole'
        db.create_table('categories_projectrole', (
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Project'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Role'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('categories', ['ProjectRole'])

        # Deleting model 'Taxonomy'
        db.delete_table('categories_taxonomy')

        # Deleting model 'TaxonomyRole'
        db.delete_table('categories_taxonomyrole')

        # Adding field 'Project.client'
        db.add_column('categories_project', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categories.Client']),
                      keep_default=False)

        # Deleting field 'Project.taxonomy'
        db.delete_column('categories_project', 'taxonomy_id')
    ...
    models = {
        ...
        'categories.project': {
            ...
            'taxonomy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Client']"})
        },
