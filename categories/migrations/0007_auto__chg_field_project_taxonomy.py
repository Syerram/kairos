...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.taxonomy'
        db.alter_column('categories_project', 'taxonomy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Taxonomy']))

    def backwards(self, orm):

        # Changing field 'Project.taxonomy'
        db.alter_column('categories_project', 'taxonomy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Client']))
