...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PayCodeType'
        db.create_table('categories_paycodetype', (
            ...
            ('multiplier', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('categories', ['PayCodeType'])


    def backwards(self, orm):
        # Deleting model 'PayCodeType'
        db.delete_table('categories_paycodetype')
