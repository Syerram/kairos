...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JointPoint.content_type'
        db.delete_column('rules_jointpoint', 'content_type_id')

        # Adding field 'RuleSet.content_type'
        db.add_column('rules_ruleset', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='content_type', to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JointPoint.content_type'
        db.add_column('rules_jointpoint', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='content_type', to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Deleting field 'RuleSet.content_type'
        db.delete_column('rules_ruleset', 'content_type_id')
