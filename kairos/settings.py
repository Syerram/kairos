...
DATABASES = {
    'default': {
        ...
        'NAME': 'kairos',                      # Or path to database file if using sqlite3.
        'USER': 'kairos',                      # Not used with sqlite3.
        'PASSWORD': 'kairos1234',                  # Not used with sqlite3.
...
MEDIA_ROOT = os.path.join(SITE_ROOT, 'web/media')
...
SECRET_KEY = 'x!=$u)s9$+pvbg7a!5%)xisay#1%@td7vy!9l@lz4gd^zqcj_t'
